...
public class CPP14Parser extends Parser {
	...
	public static class CannonicalforestatementContext extends IterationstatementContext {
		...
		public CannonicalforestatementContext(IterationstatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CPP14Listener ) ((CPP14Listener)listener).enterCannonicalforestatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CPP14Listener ) ((CPP14Listener)listener).exitCannonicalforestatement(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CPP14Visitor ) return ((CPP14Visitor<? extends T>)visitor).visitCannonicalforestatement(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NoncannonicalfortatementContext extends IterationstatementContext {
		public TerminalNode For() { return getToken(CPP14Parser.For, 0); }
		...
		public NoncannonicalfortatementContext(IterationstatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CPP14Listener ) ((CPP14Listener)listener).enterNoncannonicalfortatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CPP14Listener ) ((CPP14Listener)listener).exitNoncannonicalfortatement(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CPP14Visitor ) return ((CPP14Visitor<? extends T>)visitor).visitNoncannonicalfortatement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final IterationstatementContext iterationstatement() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				break;
			case 3:
				_localctx = new CannonicalforestatementContext(_localctx);
				enterOuterAlt(_localctx, 3);
				{
				setState(1119);
				match(For);
				...
				break;
			case 4:
				_localctx = new NoncannonicalfortatementContext(_localctx);
				enterOuterAlt(_localctx, 4);
				{
				setState(1132);
				match(For);
