...
public interface CPP14Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code cannonicalforestatement}
	 * labeled alternative in {@link CPP14Parser#iterationstatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCannonicalforestatement(CPP14Parser.CannonicalforestatementContext ctx);
	/**
	 * Visit a parse tree produced by the {@code noncannonicalfortatement}
	 * labeled alternative in {@link CPP14Parser#iterationstatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNoncannonicalfortatement(CPP14Parser.NoncannonicalfortatementContext ctx);
	/**
